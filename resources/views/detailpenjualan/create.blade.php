        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="form-group">
                        <label for="id_penjualan">Nomor Nota Jual</label>
                        <div class="input-group">
                            <input type="hidden" name="id_penjualan" id="id_penjualan" value="{{old('id_penjualan')}}">
                            <input type="text" class="form-control
@error('penjualan') is-invalid @enderror" placeholder="penjualan" id="penjualan" name="penjualan" value="{{old('penjualan')}}" arialabel="penjualan" aria-describedby="cari" readonly>
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari" data-bs-target="#staticBackdrop"></i>
                                Cari Nomor Nota Jual</button>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control
@error('obat') is-invalid @enderror" placeholder="Cari Nama Obat" id="obat" name="obat" value="{{old('obat')}}"
                                arialabel="obat" aria-describedby="cari" readonly>
                            <button class="btn btn-warning" type="button" data-bs-toggle="modal" id="cari"
                                data-bs-target="#staticBackdrop1"></i>
                                Cari Nama Obat</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="jumlah_jual">Jumlah Penjualan</label>
                        <input type="number" class="form-control
@error('jumlah_jual') is-invalid @enderror" id="jumlah_jual" placeholder="Jumlah Penjualan" name="jumlah_jual"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('harga_jual') is-invalid @enderror"
                            id="harga_jual" placeholder="Harga Penjualan"  name="harga_jual"
                            value="{{old('harga_jual')}}" onchange = "subto()">
                        @error('harga_jual') <span class="textdanger">{{$message}}</span> @enderror
                    </div>

                    <div class="form-group">
                        <label for="sub_total_jual">Subtotal Penjualan</label>
                        <input type="number" class="form-control @error('sub_total_jual') is-invalid @enderror"
                            id="sub_total_jual" placeholder="Subtotal Penjualan" name="sub_total_jual"
